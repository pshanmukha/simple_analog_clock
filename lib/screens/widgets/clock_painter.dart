...
class ClockPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // second line calculation and draw paint
    double secondX = centerX + size.width * 0.4 * cos((dateTime.second * 6) * pi / 180);
    double secondY = centerX + size.width * 0.4 * sin((dateTime.second * 6) * pi / 180);

    canvas.drawLine(center, Offset(secondX, secondY),
        Paint()..color = Theme.of(context).primaryColor);

    // hour line calculation and draw paint
    ...
    // minute line calculation and draw paint
    double minX =
